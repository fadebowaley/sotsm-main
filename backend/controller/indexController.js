...
//         "jobTitle",
//       ],
//       required: false, // Use left join to include records even if there's no match in Department table
//     },
//     {
//       model: Church,
//       attributes: [
...
//         "employeeId",
//       ],
//       required: false, // Use left join to include records even if there's no match in Church table
//     },
//   ],
//   where: { employeeId: userId },
// });
...
const userDetail = await User.findAll({
  ...
  where: { employeeId: String(userId) }, // Explicitly cast userId to string
});
